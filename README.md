...
## 其他頁面
### 📱首頁<br>使用者可在首頁找尋各類影片，並有先前觀看紀錄可繼續觀看
<img src="assets/images/ReadMe-image/index.png" style="height: 300px; max-width: 100%">

### 📱帳戶頁<br>使用者可於帳戶頁觀看自己的統計紀錄，以及其他設定等項目
<img src="assets/images/ReadMe-image/profile.png" style="height: 300px; max-width: 100%">

### 📱搜尋頁<br>使用者可於此頁面觀看當前熱門搜尋影片，亦可找尋欲觀看之影片
<img src="assets/images/ReadMe-image/search.png" style="height: 300px; max-width: 100%">

### 📱個人片單頁<br>此頁面為使用者有加入片單之頁面，可查找過去曾加入的影片清單
<img src="assets/images/ReadMe-image/playlist.png" style="height: 300px; max-width: 100%">
